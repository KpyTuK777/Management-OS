...
```text
M8.3 — Information, Evidence, and Handoff Architecture — Ready for Architecture Definition
```
...
scope-bounded opening order supplies only the stage objective, dependencies,
exclusions, and completion boundary; definition work has not begun.
...
| 3 | M8.3 — Information, Evidence, and Handoff Architecture | Active — Ready for Architecture Definition |
