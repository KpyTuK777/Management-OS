...
```text
M8.7 — Integrated Architecture Review — Ready for Canonical Review
```
...
candidate is Architecture Approved and awaits independent Canonical Review.
...
| 7 | M8.7 — Integrated Architecture Review | Active — Ready for Canonical Review |
