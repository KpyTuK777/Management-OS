...
- [M6 — Canonical Design Semantics](M6%20-%20Canonical%20Design%20Semantics.md) — **Ready for Architecture Review**. Defines fourteen platform-independent semantic roles, independent qualifiers, composition rules, object mappings, adapter equivalence, and conformance criteria without defining appearance or implementation.
- [M6.3 — Canonical Rendering Model](M6.3%20-%20Canonical%20Rendering%20Model.md) — **Ready for Architecture Review**. Defines the platform-independent Rendering Tree, eleven Design Object-to-Rendering Node mappings, deterministic transformation, composition, replacement, degradation, invariants, adapter independence, and conformance without defining implementation technology.
