...
- [M6 — Canonical Design Semantics](M6%20-%20Canonical%20Design%20Semantics.md) — **Architecture Definition**. Defines fourteen platform-independent semantic roles, independent qualifiers, composition rules, object mappings, adapter equivalence, and conformance criteria without defining appearance or implementation.
