...
- [M6.10 — Rendering Contracts and Platform Adapters](M6.10%20-%20Rendering%20Contracts%20and%20Platform%20Adapters.md) — **Ready for Architecture Review**. Defines AC-01–AC-11, the aggregate Adapter Contract Set, deterministic capability matching, fallback and degradation, conformance evidence, and the three-layer Canonical Presentation Architecture, Platform Adapter, and Platform UI Framework boundary.
