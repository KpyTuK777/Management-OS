...
- [M6 — Canonical Operational Design System Charter](M6%20-%20Canonical%20Operational%20Design%20System%20Charter.md) — **Complete / Milestone Closed**. Defines the purpose, scope, canonical inputs, output artifact classes, principles, boundaries, deliverable documents, and completion criteria for M6 without designing UI or components.
- [M6 — Canonical Operational Design System Final Review](M6%20-%20Canonical%20Operational%20Design%20System%20Final%20Review.md) — Preserves the first immutable verdict **Canonical Operational Design System Requires Corrections** and RC-01–RC-03.
- [M6 — Canonical Operational Design System Repeat Final Review](M6%20-%20Canonical%20Operational%20Design%20System%20Repeat%20Final%20Review.md) — Records correction verification, all seventeen required responsibilities, all fifteen completion criteria, cross-canonical and repository checks, and the closing verdict **Canonical Operational Design System Complete**.
- [M6.C1 — Iconography Implementation Contract](M6.C1%20-%20Iconography%20Implementation%20Contract.md) — **Approved for M6 dependency use**. RC-01 correction-stage definition governing exact semantic binding, symbol occurrences, qualifiers, composition, ambiguity prevention, accessibility equivalence, lifecycle, degradation, recovery, adapter realization, mapping, and evidence without defining an icon set or implementation.
- [M6.C1 — Iconography Implementation Contract Architecture Review](M6.C1%20-%20Iconography%20Implementation%20Contract%20Architecture%20Review.md) — Records the independent review of IS-01–IS-10, all 78 invariants, ambiguity, accessibility, lifecycle, adapter boundary, mapping, evidence, and exclusions, with the disposition **Approved for M6 dependency use**.
- [M6 — Canonical Design Object Model](M6%20-%20Canonical%20Design%20Object%20Model.md) — **Approved for dependency use**. Defines the platform-independent Design System subject model, its eleven semantic object types, permitted relationships, responsibilities, mapping constraints, and conformance invariants without defining components or layout.
...
- [M6.1–M6.12 — Consolidated Architecture Review Evidence](M6.1-M6.12%20Consolidated%20Architecture%20Review%20Evidence.md) — Records twelve individually inspectable Architecture Reviews covering all model dependencies, taxonomies, boundaries, 458 combined invariants, findings, and separate dispositions of **Approved for M6 dependency use**.
...
- [M6.15 — Conformance and Governance Framework](M6.15%20-%20Conformance%20and%20Governance%20Framework.md) — **Approved for M6 dependency use**. Defines the independently reviewable Conformance and Governance Contracts, CF-01–CF-16 taxonomy, exact-revision evidence and deterministic qualification, authority-preserving change governance, final M6 gates, and the canonical-to-qualified-realization boundary without implementation mechanics.
- [M6.15 — Conformance and Governance Framework Architecture Review](M6.15%20-%20Conformance%20and%20Governance%20Framework%20Architecture%20Review.md) — Records the independent review of CF-01–CF-16, evidence, verdicts, governance, all 76 invariants, authority separation, final gates, and repository consistency, with the disposition **Approved for M6 dependency use**.
