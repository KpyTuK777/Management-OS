...
| **Canonical Iconography Research** | Advisory symbol research, construction concerns, and accessibility observations | Research is not semantic authority. Navigation semantics precedes representation; decorative causality is prohibited. Canonical Visual Semantics is the Canonical semantic owner that a future icon library must implement. |
