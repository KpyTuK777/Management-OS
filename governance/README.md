...
| M7.5 | Autonomous Development Protocol | Normative definition | Ready for Canonical Review / Approved for dependency use | [Definition](normative/M7.5%20-%20Autonomous%20Development%20Protocol.md) |
| M7.5 | Autonomous Development Protocol Definition Evidence | Evidence | Accepted Architecture Review evidence | [Evidence](evidence/M7.5%20-%20Autonomous%20Development%20Protocol%20Definition%20Evidence.md) |
...
Active with one Architecture Approved Autonomous Development Protocol ready for
Canonical Review, its bounded order, accepted definition evidence, and completed
Architecture Review. Child indexes list each artifact only in its applicable
class; M7.6–M7.7 remain without substantive artifacts.
