...
is Active with only its bounded opening order; no substantive Organizational
Model exists. Child indexes list each artifact only in its applicable class;
M7.4–M7.7 remain without substantive artifacts.
