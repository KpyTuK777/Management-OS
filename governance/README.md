...
| M7.5 | Autonomous Development Protocol | Normative definition | Ready for Architecture Review | [Definition](normative/M7.5%20-%20Autonomous%20Development%20Protocol.md) |
| M7.5 | Autonomous Development Protocol Definition Evidence | Evidence | Prepared for Architecture Review | [Evidence](evidence/M7.5%20-%20Autonomous%20Development%20Protocol%20Definition%20Evidence.md) |
...
Active with one review-ready Autonomous Development Protocol candidate, its
bounded order, and definition evidence. Child indexes list each artifact only
in its applicable class; M7.6–M7.7 remain without substantive artifacts.
