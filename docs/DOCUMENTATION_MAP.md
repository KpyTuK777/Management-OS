...
| Operational Situation Board mental model, operational picture, stable frame, cognitive center, natural capture, Reasoning Milestones, and progressive disclosure | [Operational Situation Board Architecture](OPERATIONAL_SITUATION_BOARD_ARCHITECTURE.md) |
| Pre-v1.0 Cognitive Cleanup, explanation-versus-interaction criteria, risk-sensitive disclosure, and cleanup validation | [Cognitive Cleanup Architecture](COGNITIVE_CLEANUP_ARCHITECTURE.md) |
| Progressive Understanding, Progressive Construction, cognitive readiness, Living Situation Board safeguards, and Operational Language relationship | [Progressive Understanding Architecture](PROGRESSIVE_UNDERSTANDING_ARCHITECTURE.md) |
| Human-first Investigation opening, Watson intervention contract, owner correction, and Situation Board timing | [Human-first Investigation Experience](HUMAN_FIRST_INVESTIGATION_EXPERIENCE.md) |
| Operational Workbench composition, Current Situation, Operational Inbox, progressive Working Collections, and Decision-relative emphasis | [Operational Workbench](OPERATIONAL_WORKBENCH.md) |
| Operational System definition and boundary, process participation, Process Condition Assessment, Operational System Map, and Stabilization Assessment | [Operational System Architecture](OPERATIONAL_SYSTEM_ARCHITECTURE.md) |
| Post-Decision Operational Transition, Intended Operating Condition, cross-capability coordination, current-intended-observed comparison, and completion boundaries | [Operational Transition Architecture](OPERATIONAL_TRANSITION_ARCHITECTURE.md) |
| Operational topology, process-understanding projections, provenance, sensitivity, freshness, and reasoning-use boundaries | [Operational Operating Model](OPERATIONAL_OPERATING_MODEL.md) |
| Decision-impact analysis, proposed adaptations, owner disposition, proportional skip, and Execution Planning handoff | [Operational Impact Review Architecture](OPERATIONAL_IMPACT_REVIEW_ARCHITECTURE.md) |
...
| Authoritative architecture sequencing and current process | [Architecture control plane](../architecture/README.md) |
| Legacy product planning record | [Roadmap](ROADMAP.md) |
...
| `docs/ROADMAP.md` | Historical product planning | Preserve the roadmap used before the Architecture Process Bootstrap. | Product Owner | Historical reference | Do not update for current architecture sequencing | Legacy; `architecture/ROADMAP.md` is authoritative | Product Vision, Sprints, Systems |
...
| `docs/OPERATIONAL_SITUATION_BOARD_ARCHITECTURE.md` | Experience architecture | Define the Matter-level owner mental model, projected operational picture, stable frame, dynamic cognitive center, Natural Capture integration, Reasoning Milestones, progressive disclosure, and degraded operation. | Product Architect & AI Strategist | Product, design, architecture, engineering, AI, research, data, governance, and documentation collaborators | With approved Matter-workspace philosophy, cognitive-focus, reasoning-change, or capture changes | Canonical future experience architecture; deterministic prototype aligned | Operational Matter, Operational Case Experience, Natural Capture, AI Assistant, Operational Reasoning |
| `docs/GUIDED_INVESTIGATION_INTERACTION.md` | Interaction architecture | Define the Situation Board attention hierarchy, dominant interaction, concise supporting context, inspectable workspace, owner controls, and guidance recalculation. | Product Architect & AI Strategist | Product, design, architecture, engineering, AI, research, quality, and documentation collaborators | With approved Guided Investigation or attention-hierarchy changes | Canonical interaction architecture; deterministic prototype aligned | Operational Situation Board, Operational Inquiry, Natural Capture, AI Assistant, Design System |
| `docs/PERCEPTUAL_ARCHITECTURE.md` | Product experience and design architecture | Define the Board, Natural Capture, and Watson surface roles, perceptual character, cross-surface visual language, context connection, and responsive role preservation. | Product Architect & Design Owner | Product, design, architecture, engineering, AI, research, quality, accessibility, and documentation collaborators | With approved primary-workspace perceptual-role or cross-surface design changes | Canonical product-experience and design architecture; deterministic prototype aligned | Operational Situation Board, Guided Investigation, Natural Capture, AI Assistant, Design System |
| `docs/COGNITIVE_CLEANUP_ARCHITECTURE.md` | Product experience architecture | Define the pre-v1.0 Cognitive Cleanup phase, explanation-versus-interaction criteria, permanent and progressive information, cleanup principles, guardrails, and exit validation. | Product Architect & AI Strategist | Product, design, architecture, engineering, AI, research, quality, accessibility, governance, and documentation collaborators | During pre-v1.0 cleanup and with approved cognitive-load or disclosure changes | Canonical pre-v1.0 experience authority; prototype cleanup aligned | Operational Situation Board, Product Vision, Owner Journey Validation, Design System, Product Language |
| `docs/PROGRESSIVE_UNDERSTANDING_ARCHITECTURE.md` | Cross-capability cognitive architecture | Define Progressive Understanding, Progressive Construction, cognitive readiness, Living Situation Board behavior, sequencing safeguards, and the Operational Language relationship. | Product Architect & AI Strategist | Product, architecture, design, operations, engineering, AI, research, quality, accessibility, governance, and documentation collaborators | With approved cognitive-readiness, construction, sequencing, or language-boundary changes | Canonical future architecture; not implemented | Operational Situation Board, Guided Investigation, Operational Inquiry, Natural Capture, Operational Impact Review, Product Language |
| `docs/HUMAN_FIRST_INVESTIGATION_EXPERIENCE.md` | Product experience architecture | Define conversation-led orientation, the Watson intervention contract, owner correction, Board timing, direct access, and safeguard interruptions. | Product Architect & AI Strategist | Product, design, architecture, operations, engineering, AI, research, quality, accessibility, governance, and documentation collaborators | With approved first-Investigation interaction or Board-timing changes | Canonical product-experience architecture; deterministic prototype aligned | Progressive Understanding, Guided Investigation, Operational Situation Board, Perceptual Architecture |
| `docs/OPERATIONAL_WORKBENCH.md` | Product experience architecture | Define the stable Matter workspace metaphor, Current Situation composition, Operational Inbox presentation, progressive Working Collections, continuity, and Decision-relative emphasis. | Product Architect & AI Strategist | Product, design, architecture, operations, engineering, AI, research, quality, accessibility, governance, and documentation collaborators | With approved Workbench composition, collection, Inbox, or emphasis changes | Canonical product-experience architecture; deterministic prototype aligned | Human-first Investigation, Operational Situation Board, Natural Capture, Operational Transition |
| `docs/OPERATIONAL_SYSTEM_ARCHITECTURE.md` | Strategic operational architecture | Define the bounded real-world Operational System, system-versus-model distinction, process participation, Process Condition Assessment, Operational System Map, Stabilization Assessment, and integration boundaries. | Product Architect & AI Strategist | Product, architecture, operations, design, engineering, data, AI, governance, integration, and documentation collaborators | With approved Operational System, process-condition, system-map, or stabilization changes | Canonical future architecture; not implemented | Operational Operating Model, Operational Matter, Operational Situation Board, Operational Impact Review, Progressive Understanding, Operational Memory |
| `docs/OPERATIONAL_TRANSITION_ARCHITECTURE.md` | Strategic operational architecture | Define post-Decision Operational Transition, Intended Operating Condition, Understanding and Change Arcs, cross-capability coordination, current-intended-observed comparison, proportionality, and completion boundaries. | Product Architect & AI Strategist | Product, architecture, operations, design, engineering, delivery, AI, governance, integration, and documentation collaborators | With approved post-Decision transition, intended-condition, coordination, or completion-boundary changes | Canonical future architecture; not implemented | Operational Matter, Operational Reasoning Model, Operational System, Operational Operating Model, Operational Impact Review, Operational Situation Board, Operational Memory |
...
| `docs/OPERATIONAL_OPERATING_MODEL.md` | Product and operating-model architecture | Define governed operational topology, process-understanding projections, provenance, sensitivity, freshness, correction, and reasoning-use boundaries. | Product Architect & AI Strategist | Product, architecture, operations, privacy, security, design, engineering, AI, and documentation collaborators | With approved operational-topology changes | Canonical future architecture; not implemented | Unified Operational Investigation, Operational Impact Review, Case Evidence, Personal Operational Model, Owner Identity |
| `docs/OPERATIONAL_IMPACT_REVIEW_ARCHITECTURE.md` | Product and decision-impact architecture | Define proportionate post-Decision impact reasoning, proposed adaptations, owner disposition, planning handoff, and authority boundaries. | Product Architect & AI Strategist | Product, architecture, operations, design, engineering, AI, governance, and documentation collaborators | With approved Decision-impact or planning-handoff changes | Canonical future architecture; not implemented | Operational Matter, Unified Operational Investigation, Operational Operating Model, Operational Memory, Knowledge Evolution |
| `docs/INVESTIGATION_ORCHESTRATION_ARCHITECTURE.md` | AI capability and Investigation architecture | Define Evidence Needs, Operational Actions, explainable sequencing, Evidence Acquisition Profiles, scheduling handoffs, and owner authority. | Product Architect & AI Strategist | Product, architecture, operations, design, engineering, AI, privacy, and documentation collaborators | With approved Investigation orchestration changes | Canonical future capability architecture; not implemented | Operational Inquiry, Case Evidence, Operational Operating Model, AI Assistant |
