...
| Operational Situation Board mental model, operational picture, stable frame, cognitive center, natural capture, and progressive disclosure | [Operational Situation Board Architecture](OPERATIONAL_SITUATION_BOARD_ARCHITECTURE.md) |
...
| `docs/OPERATIONAL_SITUATION_BOARD_ARCHITECTURE.md` | Experience architecture | Define the Matter-level owner mental model, projected operational picture, stable frame, dynamic cognitive center, Natural Capture integration, progressive disclosure, and degraded operation. | Product Architect & AI Strategist | Product, design, architecture, engineering, AI, research, data, governance, and documentation collaborators | With approved Matter-workspace philosophy, cognitive-focus, or capture changes | Canonical future experience architecture; prototype presentation aligned | Operational Matter, Operational Case Experience, Natural Capture, AI Assistant, Operational Reasoning |
