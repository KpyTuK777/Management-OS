...
| Unified Investigation lifecycle, Investigation Context, navigation model, and Decision Laboratory placement | [Unified Operational Investigation Architecture](UNIFIED_OPERATIONAL_INVESTIGATION_ARCHITECTURE.md) |
...
| `docs/UNIFIED_OPERATIONAL_INVESTIGATION_ARCHITECTURE.md` | Product architecture | Define the single Investigation lifecycle, Investigation Context behavior and defaults, unified navigation, and Decision Laboratory placement. | Product Architect & AI Strategist | Product, architecture, design, engineering, AI, and documentation collaborators | With approved unified Investigation changes | Canonical future architecture; prototype aligned | Operational Case, Operational Reasoning Model, Operational Inquiry, Scenario Simulation, AI-first Workspace |
