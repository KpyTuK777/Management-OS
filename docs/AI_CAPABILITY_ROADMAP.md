...
| Investigation Orchestration | Prepare explainable, constraint-aware Evidence acquisition and Operational Action sequences | Reduces Investigation delay and friction without transferring authority | Operational Inquiry, Case Evidence, Operational Organization Model, Calendar and task handoffs, approval | P1 | Post-v1 Investigation capability |
| Operational Organization Model | Represent governed availability, constraints, systems, relationships, and Evidence-access context | Makes Investigation planning realistic and organization-specific | Source governance, identity, privacy, provenance, freshness, correction | P0 | Post-v1 |
