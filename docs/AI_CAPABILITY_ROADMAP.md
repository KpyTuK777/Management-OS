...
| Investigation Orchestration | Prepare explainable, constraint-aware Evidence acquisition and Operational Action sequences | Reduces Investigation delay and friction without transferring authority | Operational Inquiry, Case Evidence, Operational Operating Model, Calendar and task handoffs, approval | P1 | Post-v1 Investigation capability |
| Operational Operating Model | Represent governed processes, structure, systems, roles, controls, constraints, relationships, and Evidence-access context | Makes Investigation, impact analysis, and planning realistic and organization-specific | Source governance, identity, privacy, provenance, freshness, correction | P0 | Post-v1 |
| Operational Impact Review | Evaluate how an approved Decision propagates through the operating system and prepare owner-approved adaptations for planning | Reduces secondary failure and missed organizational adaptation without reconsidering the Decision | Decision, Operational Operating Model, process understanding, owner approval, Execution Planning | P1 | Post-v1 |
...
| Organizational Knowledge Model | Represent approved reusable understanding about how the organization operates | Grounds guidance in governed organizational knowledge | Data quality, privacy, provenance, correction, knowledge governance | P0 | Post-v1 |
